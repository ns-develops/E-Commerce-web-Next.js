  ...
  return (
    <div
      ...
      className={cn(
        ...
        "border-radius-0",
        "w-[250px] h-[500px]", // <-- justering: smalare och högre kort
        className
      )}
      {...props}
    />
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("leading-none font-semibold", "border-radius-0", className)}
      {...props}
    />
  )
}
...
function CardDescription({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("text-muted-foreground text-sm", "border-radius-0", className)}
      {...props}
    />
  )
}
